...
public abstract class UploadPhotoApi implements Cloneable {
    protected final String BOUNDARY = "END_OF_PART";
    ...
    public void setUploadDataPath(String uploadDataPath) {
    ...
    protected abstract HttpsURLConnection setupConnection(HttpsURLConnection connection) throws Exception;
}
